...
void Graphics_Renderer2D(bool isOpenGLMode)
{
	...
	auto window = asd::Window_Imp::Create(640, 480, asd::ToAString(u"Renderer2D").c_str(), log, false, asd::WindowPositionType::Default, isOpenGLMode? asd::GraphicsDeviceType::OpenGL: asd::GraphicsDeviceType::DirectX11, asd::ColorSpaceType::LinearSpace, false);
