...
void Graphics_PostEffectRenderer(bool isOpenGLMode)
{
	...
	auto window = asd::Window_Imp::Create(640, 480, asd::ToAString(u"PostEffect").c_str(), log, asd::WindowPositionType::Default, isOpenGLMode ? asd::GraphicsDeviceType::OpenGL : asd::GraphicsDeviceType::DirectX11, asd::ColorSpaceType::LinearSpace, false);
