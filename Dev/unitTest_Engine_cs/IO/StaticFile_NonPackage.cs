...
{
    class StaticFile_NonPackage : EngineTest
    {

        public StaticFile_NonPackage()
            : base(1)
        {
        }
        ...
        protected override void OnStart()
        {
            ...
            //ファイル機能から読み込んだバイナリ
            asd.Engine.File.AddRootDirectory("Data/Texture/Surface");
            var staticFile = asd.Engine.File.CreateStaticFile("Tile_Spec.png");
