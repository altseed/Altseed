...
namespace asd {
	...
	*/
	...
	protected:
		...
		DepthBuffer_Imp_DX11(Graphics* graphics, ar::DepthTexture* rhi, ID3D11Texture2D* depthBuffer, ID3D11DepthStencilView* depthStencilView, ID3D11ShaderResourceView* depthSRV, Vector2DI size);
