...
namespace asd
{
	...
	*/
	...
	EnvironmentRendering::EnvironmentRendering(Graphics* graphics, std::shared_ptr<asd::VertexBuffer_Imp> vb, std::shared_ptr<asd::IndexBuffer_Imp> ib)
	{
		...
		float diffuseColorIntensity, float specularColorIntensity, CubemapTexture* diffuseColor, CubemapTexture* specularColor)
	{
		...
		helper->Draw(2, vertexBuffer.get(), indexBuffer.get(), environmentShader.get(), state,
			...
			h::GenValue("g_diffuseTexture", h::CubemapTexturePair(diffuseColor, asd::TextureFilterType::Linear, asd::TextureWrapType::Clamp)),
			h::GenValue("g_specularTexture", h::CubemapTexturePair(specularColor, asd::TextureFilterType::Linear, asd::TextureWrapType::Clamp)),
			h::GenValue("g_brdfTexture", h::Texture2DPair(brdfTexture.get(), asd::TextureFilterType::Linear, asd::TextureWrapType::Clamp)),
