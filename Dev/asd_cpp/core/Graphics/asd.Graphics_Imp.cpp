...
Texture2D_Imp* Graphics_Imp::CreateEmptyTexture2D_Imp_Internal(Graphics* graphics, int32_t width, int32_t height, TextureFormat format, void* data)
{
...
DepthBuffer_Imp* Graphics_Imp::CreateDepthBuffer_Imp(int32_t width, int32_t height)
{
	return DepthBuffer_Imp::Create(this, width, height);
}
