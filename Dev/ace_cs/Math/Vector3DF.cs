...
namespace ace
{
	...
	public struct Vector3DF
	{
		...
		/// <returns>内積</returns>
		static float Dot(ref Vector3DF v1, ref Vector3DF v2)
		{
		...
		/// <param name="v2"></param>
		/// <returns></returns>
		Vector3DF Cross( ref Vector3DF v1, ref Vector3DF v2 )
		{
			Vector3DF o;
		...
		/// <param name="v2">値2</param>
		/// <returns>距離</returns>
		static float Distance(ref Vector3DF v1, ref Vector3DF v2)
		{
			float dx = v1.X - v2.X;
			float dy = v1.Y - v2.Y;
			float dz = v1.Z - v2.Z;
