...
class ObjectSystem_CollidingEvent : public EngineTest
{
...
public:
	ObjectSystem_CollidingEvent(bool isOpenGLMode)
		: EngineTest(asd::ToAString("CollidingEvent"), isOpenGLMode, 600)
	{
	}
...
ENGINE_TEST(ObjectSystem, CollidingEvent)
