...
with aceutils.CurrentDir('../Downloads'):
	...
	with aceutils.CurrentDir('culling2d_bin'):
		if aceutils.isWin():
			...
			aceutils.call(r'cmake -G "Unix Makefiles" -D USE_MSVC_RUNTIME_LIBRARY_DLL:BOOL=OFF "-DCMAKE_OSX_ARCHITECTURES=x86_64;i386" ../Culling2D/')
			aceutils.call(r'make')
		else:
			aceutils.call(r'cmake -G "Unix Makefiles" -D USE_MSVC_RUNTIME_LIBRARY_DLL:BOOL=OFF ../Culling2D/')
			aceutils.call(r'make')
